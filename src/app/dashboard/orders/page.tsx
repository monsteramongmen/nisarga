    ...
    <>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {filteredOrders.map((order) => (
          <Card key={order.id} className="flex flex-col hover:shadow-lg transition-shadow">
            <CardHeader>
              <div className="flex justify-between items-start">
                  <div className="flex-1">
                      <CardTitle className="cursor-pointer" onClick={() => handleOpenForm(order)}>{order.eventName}</CardTitle>
      ...
      <Dialog open={isCancelDialogOpen} onOpenChange={(open) => {
        ...
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Please provide a reason for cancelling order #{editingOrder?.id}.
            </DialogDescription>
          </DialogHeader>
